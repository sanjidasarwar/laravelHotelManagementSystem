        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{!empty($profileDetails->photo) ? url('upload/admin_images/'.$profileDetails->photo) : url('upload/no_image.jpg')}}" class="user-img" alt="user avatar">
                    <div class="user-info">
                        <p class="user-name mb-0">{{$profileDetails->name}}</p>
                        <p class="designattion mb-0">{{$profileDetails->email}}</p>
                    </div>
                </a>
